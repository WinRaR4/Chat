# Generated by Django 3.1.3 on 2021-02-01 08:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Twit_app.room', verbose_name='Комната чата')),
